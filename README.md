...
The repository rheem-jdbc-template it merge to apache wayang on the folder [wayang-platforms/wayang-jdbc-template](https://github.com/apache/incubator-wayang/tree/main/wayang-platforms/wayang-jdbc-template)
